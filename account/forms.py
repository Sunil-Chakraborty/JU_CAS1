...
class AccountCasForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'dt_ob'         : widgets.DateInput(attrs={'class': 'form-control','type': 'date','style': 'width:400px;'}),
...
class AcademyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'degree'                : widgets.Textarea(attrs={'class': 'form-control', 'rows': 3,'style': 'text-transform:uppercase;height:7px;font-size:18px;', 'initial':'Blank' }),
            'name_board_university' : widgets.Textarea(attrs={'class': 'form-control','title': 'Your University', 'rows': 3,'style': 'text-transform:uppercase;font-size:18px;' }),
            'div_class_grade'       : widgets.Textarea(attrs={'class': 'form-control', 'rows': 3,'style': 'text-transform:uppercase;font-size:18px;' }),
            'subject'               : widgets.Textarea(attrs={'class': 'form-control', 'rows': 3,'style': 'text-transform:uppercase;font-size:18px;' }),
            ...
            'doc_link'      : widgets.URLInput(attrs={'class':'form-control','style': 'width:400px;height:3em;;font-size:18px;'}),
    ...
    def clean(self):
            ...
            if cleaned_data['doc_link']:
                ...
                try:
                    ...
                    raise forms.ValidationError(u'Check the URL.')
    """
...
class ApiCatg_IForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {            
            ...
            'url_dt'              : widgets.URLInput(attrs={'class':'form-control','style': 'width:600px;height:3em;'}),    
            'url_ed'              : widgets.URLInput(attrs={'class':'form-control','style': 'width:600px;height:3em;'}),    
            'url_it'              : widgets.URLInput(attrs={'class':'form-control','style': 'width:600px;height:3em;'}),    
